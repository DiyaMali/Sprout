...
export function Navigation() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed top-0 w-full z-50 bg-surface/80 nav-blur border-b border-primary/5">
      <div className="flex justify-between items-center px-margin-mobile md:px-margin-desktop py-6 max-w-container-max mx-auto">
        ...
        <div className="hidden md:flex items-center gap-4 relative">
          {user ? (
              ...
              {dropdownOpen && (
                <>
                  ...
                  <div
                    ...
                    className="absolute right-0 mt-2 w-48 bg-white/90 backdrop-blur-md border border-primary/5 rounded-xl shadow-lg p-2 z-40 animate-fade-rise"
                  >
            ...
            <Link
              href="/login"
              className="bg-primary text-on-primary px-6 py-2.5 rounded-full text-sm font-medium hover:opacity-90 transition-opacity text-center"
            >
              Sign In
            </Link>
          )}
